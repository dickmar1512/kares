...
<%	
	...
	// Generar archivos de texto plano para SUNAT
	// Código comentado - se puede descomentar si se necesita generar archivos
		/*archivo .CAB*/
		 File f = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".cab");  
		  ...
		  //Escritura
			...
			wr.append("0101|"+p_fecha+"|"+p_hora+"|-|0000|1|"+s_dni+"|"+x_pac+"|PEN|0|"+sumtot+"|"+sumtot+"|0|0|0|"+sumtot+"|2.1|2.0|");
			wr.close();
			bw.close();
			}
			catch(IOException e)
	  ...
	  /*archivo .PAG*/
		 File fp = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".pag");  
	  ...
	  /*ARCHIVO .ACA*/
	   File a = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".aca");
	  ...
	  /*ARCHIVO .LEY*/	
		 ...
		 File l = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".ley");
    ...
    /*ARCHIVO .TRI*/
	 File t = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".tri");
         try{
...
<head>
    ...
    <title>Boleta Electrónica - <%=x_doc%></title>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-body">
            ...
            <div class="doc-type-badge">
                ...
                <div style="margin: 0.5rem 0; font-size: 1rem; font-weight: 700;">BOLETA ELECTRÓNICA</div>
            ...
            <table class="items-table">
                ...
                <tbody>
                <%
                    // Generar archivo .DET para SUNAT (comentado)
                    
                    File d = new File("C:\\SFS_v1.3.4.4\\sunat_archivos\\sfs\\DATA\\20541177281-03-"+s_serie.trim()+"-"+s_numdoc+".det");
            ...
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                    <h5 class="modal-title" id="pdfModalLabel">
                        ...
                        Vista Previa de BOLETA ELECTRÓNICA
                    </h5>
    ...
    <script>
        ...
        try {
            ...
            $("#qrcodigo").qrcode({
                ...
                color: '#667eea',
                ecLevel: 'L',
                text: '<%="20541177281|03|"+x_doc+"|0.00|"+sumtot+"|"+x_fec+"|"%>'
            });
        } catch(e) {
        ...
        function openPDFModal(idMovVnt) {
            ...
            currentPdfUrl = 'print_boleta_electronica_pdf.jsp?f_id_mov_vnt=' + idMovVnt;
